...
namespace NeeView.PageFrames
{
    ...
    public partial class PageFrameScrollViewer : Grid, IPointControl, IScrollable
    {
        ...
        public PageFrameScrollViewer(PageFrameContext context, PageFrameContainerCanvas canvas, PageFrameViewTransform transform)
        {
            ...
            this.SetBinding(VisibilityProperty, new Binding(nameof(AppState.IsProcessingBook)) { Source = AppState.Current, Converter = new BooleanToInverseVisibilityConverter() { True = Visibility.Hidden } });
        ...
        public void ApplyAreaLimit(Point c0, Point c1)
        {
            ...
            if (!_context.ViewConfig.MovementConstraint.IsLimited) return;
