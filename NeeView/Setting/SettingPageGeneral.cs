...
namespace NeeView.Setting
{
    ...
    public class SettingPageStartUp : SettingPage
    {
        public SettingPageStartUp() : base(TextResources.GetString("SettingPage.General.Boot"))
        {
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.StartUp, nameof(StartUpConfig.IsOpenLastBookmarkFolder))));
    ...
    public class SettingPageSaveData : SettingPage
    {
        public SettingPageSaveData() : base(TextResources.GetString("SettingPage.General.SaveData"))
        {
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Bookshelf, nameof(BookshelfConfig.QuickAccessFilePath)))
            {
                IsStretch = true,
            });
