...
namespace NeeView.Setting
{
    ...
    public class SettingPageBook : SettingPage
    {
        public SettingPageBook() : base(TextResources.GetString("SettingPage.Book"))
        {
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Book, nameof(BookConfig.BookThumbnailRegex))));
    ...
    public class SettingPageBookMove : SettingPage
    {
        public SettingPageBookMove() : base(TextResources.GetString("SettingPage.Book.Move"))
        {
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Book, nameof(BookConfig.ResetNextBookPageMode))));
