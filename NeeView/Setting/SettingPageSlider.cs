...
namespace NeeView.Setting
{
    ...
    public class SettingPageSlider : SettingPage
    {
        public SettingPageSlider() : base(TextResources.GetString("SettingPage.Slider"))
        {
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Slider, nameof(SliderConfig.MouseWheelAction))));
    ...
    public class SettingPageFilmstrip : SettingPage
    {
        public SettingPageFilmstrip() : base(TextResources.GetString("SettingPage.Filmstrip"))
        {
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.FilmStrip, nameof(FilmStripConfig.MouseWheelAction))));
    ...
    public class SettingPagePageTitle : SettingPage
    {
        public SettingPagePageTitle() : base(TextResources.GetString("SettingPage.PageTitle"))
        {
            ...
            section.Children.Add(new SettingItemNote(TitleStringFormatTools.CreateHelpText(), TextResources.GetString("TitleStringFormat.Note.Title")));
