...
namespace NeeView.Setting
{
    ...
    public class SettingPageFileTypes : SettingPage
    {
        private class SettingItemCollectionDescription : ISettingItemCollectionDescription
        {
            ...
            {
                return PictureProfile.Current.DefaultFileTypes;
            }
        }

        public SettingPageFileTypes() : base(TextResources.GetString("SettingPage.Archive"))
        {
            ...
            var section = new SettingItemSection(TextResources.GetString("SettingPage.FileTypes"));

            var supportFileTypeEditor = new SettingItemCollectionControl() { Collection = (FileTypeCollection)PictureProfile.Current.SupportFileTypes.Clone(), AddDialogHeader = TextResources.GetString("Word.Extension"), IsAlwaysResetEnabled = true, Description = new SettingItemCollectionDescription() };
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Image.Standard, nameof(ImageStandardConfig.IsAnimatedWebpEnabled))));
            ...
            section = new SettingItemSection(TextResources.GetString("SettingPage.FileTypes.Svg"));
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Image.Svg, nameof(ImageSvgConfig.SupportFileTypes)),
                new SettingItemCollectionControl() { Collection = Config.Current.Image.Svg.SupportFileTypes, AddDialogHeader = TextResources.GetString("Word.Extension"), DefaultCollection = ImageSvgConfig.DefaultSupportFileTypes }));
            this.Items.Add(section);
        }
    ...
    {
        public SettingPageArchiveZip() : base(TextResources.GetString("SettingPage.Archive.Zip"))
        {
            ...
            var section = new SettingItemSection(TextResources.GetString("SettingPage.Archive.ZipFeature"));
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Archive.Zip, nameof(ZipArchiveConfig.SupportFileTypes)),
                new SettingItemCollectionControl() { Collection = Config.Current.Archive.Zip.SupportFileTypes, AddDialogHeader = TextResources.GetString("Word.Extension"), DefaultCollection = ZipArchiveConfig.DefaultSupportFileTypes }));
    ...
    {
        public SettingPageArchiveSevenZip() : base(TextResources.GetString("SettingPage.Archive.SevenZip"))
        {
            var section = new SettingItemSection(TextResources.GetString("SettingPage.Archive.SevenZipFeature"));
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Archive.SevenZip, nameof(SevenZipArchiveConfig.SupportFileTypes)),
                new SettingItemCollectionControl() { Collection = Config.Current.Archive.SevenZip.SupportFileTypes, AddDialogHeader = TextResources.GetString("Word.Extension"), DefaultCollection = SevenZipArchiveConfig.DefaultSupportFileTypes }));
    ...
    {
        public SettingPageArchivePdf() : base(TextResources.GetString("SettingPage.Archive.Pdf"))
        {
            var section = new SettingItemSection(TextResources.GetString("SettingPage.Archive.PdfFeature"));
            ...
            if (PdfArchiveConfig.IsPdfArchiveSupported)
            {
                ...
                section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Archive.Pdf, nameof(PdfArchiveConfig.SupportFileTypes)),
                     new SettingItemCollectionControl() { Collection = Config.Current.Archive.Pdf.SupportFileTypes, AddDialogHeader = TextResources.GetString("Word.Extension"), DefaultCollection = PdfArchiveConfig.DefaultSupportFileTypes }));
    ...
    {
        public SettingPageArchiveMedia() : base(TextResources.GetString("SettingPage.Archive.Media"))
        {
            var section = new SettingItemSection(TextResources.GetString("SettingPage.Archive.MediaFeature"));
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Archive.Media, nameof(MediaArchiveConfig.SupportFileTypes)),
                new SettingItemCollectionControl() { Collection = Config.Current.Archive.Media.SupportFileTypes, AddDialogHeader = TextResources.GetString("Word.Extension"), DefaultCollection = MediaArchiveConfig.DefaultSupportFileTypes }));
    ...
    {
        public SettingPageSusie() : base(TextResources.GetString("SettingPage.Susie"))
        {
            this.Items = new List<SettingItem>();

            var section = new SettingItemSection(TextResources.GetString("SettingPage.Susie.GeneralGeneral"), TextResources.GetString("SettingPage.Susie.GeneralGeneral.Remarks"));
            ...
            section = new SettingItemSection(TextResources.GetString("SettingPage.Susie.ImagePlugin"));
            section.Children.Add(new SettingItemSusiePlugin(SusiePluginType.Image));
            this.Items.Add(section);

            section = new SettingItemSection(TextResources.GetString("SettingPage.Susie.ArchivePlugin"));
